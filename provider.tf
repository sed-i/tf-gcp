...
resource "google_compute_network" "charm_dev_net" {
  name = "charm-dev-net"
}
...
resource "google_compute_firewall" "internal_all_to_all" {
  ...
  target_tags = ["charm-dev-internal-traffic"]
  source_tags = ["charm-dev-internal-traffic"]
}
...
resource "google_compute_firewall" "ssh" {
  ...
  target_tags   = ["charm-dev-ssh-traffic"]
